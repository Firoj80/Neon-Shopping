...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-border/30 bg-card text-card-foreground shadow-md transition-shadow hover:border-primary/50 hover:shadow-neon", // Default neon styling for cards
      className
    )}
    {...props}
  />
