...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=open]:ring-2 data-[state=open]:ring-secondary data-[state=open]:border-secondary data-[state=open]:shadow-neon", // Neon effect on open
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-primary" /> {/* Neon check */}
      </SelectPrimitive.ItemIndicator>
    </span>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-border/50", className)} // Slightly dimmer separator
    {...props}
  />
))
