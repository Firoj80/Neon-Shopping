...
try {
    ...
    if ($stmt_delete_list->rowCount() > 0) {
        ...
        $conn->rollBack(); 
        // This might happen if the list was already deleted by another request
        send_json_response(['success' => false, 'message' => 'Failed to delete list. It might have been already deleted or not found.'], 404);
    }
